...
- Streams typed and voice-delegated work into its original agent/session, independent of the conversation currently open. Chat scrolls to the latest message and follows streamed content, including after scrolling up.
